...
namespace HuseyinFiliz\Diff\Api\Serializers;
            ...
            if (
                ...
                $differ = new Differ(
                    ...
                    [
                        ...
                        'context' => (int)
                        $this->settings->get('huseyinfiliz-diff.neighborLines', 2),
                ...
                $rendererOptions = [
                    ...
                    'detailLevel' => $this->settings->get(
                        'huseyinfiliz-diff.detailLevel',
                        'line'
                    ),
                    // show a separator between different diff hunks in HTML renderers
                    'separateBlock' => (bool) $this->settings->get(
                        'huseyinfiliz-diff.separateBlock',
                        true
                    ),
                    'lineNumbers'    => false,
                    ...
                    .$this->translator->trans('huseyinfiliz-diff.forum.noDiff').
                    '</p></div>',
                    // this option is just for Combined renderer
                    'mergeThreshold' => \HuseyinFiliz\Diff\Jobs\ArchiveDiffs::sanitizeFloat($this->settings->get(
                        'huseyinfiliz-diff.mergeThreshold',
                        0.8
                    )),
                ];
